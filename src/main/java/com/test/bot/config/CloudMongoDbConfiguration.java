...
import com.test.bot.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.test.bot.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.test.bot.config.dbmigrations");
